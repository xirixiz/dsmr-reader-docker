...
- [DSMR-reader - Docker](#dsmr-reader---docker)
  ...
  - [HomeWizard P1 Meter Integration](#homewizard-p1-meter-integration)
...
For detailed setup instructions, troubleshooting, and Homey integration examples, see [docs/HOMEY_INTEGRATION.md](docs/HOMEY_INTEGRATION.md).

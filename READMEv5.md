...
- [Recent incompatible changes](#recent-incompatible-changes)
...
- [Setup / Parameters](#setup--parameters)
  ...
  - [DSMR Related (defaults are shown as value):](#dsmr-related-defaults-are-shown-as-value)
  - [DB Related (defaults are shown as value):](#db-related-defaults-are-shown-as-value)
  - [DSMR Datalogger Related](#dsmr-datalogger-related)
  - [DSMR Reader Datalogger - Standalone - Serial (default)](#dsmr-reader-datalogger---standalone---serial-default)
  - [DSMR Reader Datalogger - Standalone - IPv4](#dsmr-reader-datalogger---standalone---ipv4)
  - [Remote DSMR Datalogger - API Client](#remote-dsmr-datalogger---api-client)
  - [Remote DSMR Datalogger - API Server](#remote-dsmr-datalogger---api-server)
  - [Remote DSMR Datalogger - Optional Settings](#remote-dsmr-datalogger---optional-settings)
...
- [Features](#features)
  - [DSMR Reader - Database Cleanup/Vacuum](#dsmr-reader---database-cleanupvacuum)
  - [DSMR Reader - Plugins](#dsmr-reader---plugins)
  - [Backup and Restore Mechanism 1](#backup-and-restore-mechanism-1)
  - [Backup and Restore Mechanism 2](#backup-and-restore-mechanism-2)
  - [Backup Mechanism 3](#backup-mechanism-3)
  - [Postgres Upgrade (Docker)](#postgres-upgrade-docker)
  - [UID/GID](#uidgid)
- [Issues](#issues)
  - [MySQL Backend - Issue with DSMR Running on Top of MySQL](#mysql-backend---issue-with-dsmr-running-on-top-of-mysql)
